...
efsw::FileWatcher* listener = new efsw::FileWatcher();
...
efsw::WatchID watchID = listener->addWatch( "/tmp", listener, true );

// Adds another directory to watch. This time as non-recursive.
efsw::WatchID watchID2 = listener->addWatch( "/usr", listener, false );
...
efsw::WatchID watchID3 = listener->addWatch( "c:\\temp", listener, true, { (BufferSize, 128*1024) } );
